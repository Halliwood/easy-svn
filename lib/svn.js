...
var SVNClient = /** @class */ (function () {
    ...
    SVNClient.prototype.checkout = function (url, path) {
        var _a;
        return this.cmd('co', this.joinUsernameAndPassword([url || ((_a = this.cfg) === null || _a === void 0 ? void 0 : _a.responsitory), path || this.defaultCWD]));
    };
    ...
    SVNClient.prototype.commit = function (msg) {
        ...
        return this.cmd('ci', this.joinUsernameAndPassword(__spreadArray(__spreadArray([], paths, true), ["-m " + (msg || 'no message')], false)));
    };
    SVNClient.prototype.add = function () {
        ...
        return this.cmd('add', this.joinUsernameAndPassword(__spreadArray(['--force', '--parents'], paths, true)));
    };
    SVNClient.prototype.del = function (msg) {
        ...
        return this.cmd('del', this.joinUsernameAndPassword(__spreadArray(["-m " + (msg || 'no message')], paths, true)));
    };
    ...
    SVNClient.prototype.revert = function () {
        ...
        return this.cmd('revert', __spreadArray(__spreadArray([], paths, true), ['-R'], false));
    };
    /**
     *
    ...
    SVNClient.prototype.addUnversioned = function () {
        ...
        return this.cmd('add', this.joinUsernameAndPassword(__spreadArray(['--force', '--parents', '--no-ignore'], paths, true)));
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.cmd('info', this.joinUsernameAndPassword([url]))];
                    case 1:
                        info = _b.sent();
    ...
    SVNClient.prototype.joinUsernameAndPassword = function (params) {
        ...
        if ((_a = this.cfg) === null || _a === void 0 ? void 0 : _a.username) {
            params.push("--username " + ((_b = this.cfg) === null || _b === void 0 ? void 0 : _b.username));
        }
        if ((_c = this.cfg) === null || _c === void 0 ? void 0 : _c.password) {
            params.push("--password " + ((_d = this.cfg) === null || _d === void 0 ? void 0 : _d.password));
        }
        return params;
    };
