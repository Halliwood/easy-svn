...
var SVNClient = /** @class */ (function () {
    ...
    SVNClient.prototype.copy = function (src, dst) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.cmd('copy', this.joinUsernameAndPassword([src, dst, '--parents']))];
            });
        });
    };
    SVNClient.prototype.list = function (target) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.cmd('list', this.joinUsernameAndPassword([target]))];
            });
        });
    };
