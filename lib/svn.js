...
var SVNClient = /** @class */ (function () {
    ...
    SVNClient.prototype.commit = function (msg) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.cmd('ci', this.joinUsernameAndPassword(__spreadArray(__spreadArray([], paths, true), ["-m " + (msg || 'no message')], false)))];
            });
        });
    };
    ...
    SVNClient.prototype.del = function (msg) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.cmd('del', this.joinUsernameAndPassword(__spreadArray(["-m " + (msg || 'no message')], paths, true)))];
            });
        });
    };
    ...
    SVNClient.prototype.log = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.cmd('log', this.joinUsernameAndPassword([path || this.defaultCWD]))];
            });
        });
    };
